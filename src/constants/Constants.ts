...
export const PROJECT__ADD__SUBTITLE = "Krijo nje projekt te ri";
export const PROJECT__ADD__TITLE = "Shto projekt";
export const USER__ADD__SUBTITLE = "Krijo nje perdorues te ri";
export const USER__ADD__TITLE = "Shto nje perdorues";
export const FORM__CHANGE__BUTTON = "Ndrysho";
export const USER__VIEW__SUBTITLE = "Vizualizo dhe edito perdoruesin";
export const USER__VIEW__TITLE = "Detajet e perdoruesit";
export const PROJECT__VIEW__SUBTITLE = "Vizualizo dhe edito projektin";
export const PROJECT__VIEW__TITLE = "Detajet e projektit";
