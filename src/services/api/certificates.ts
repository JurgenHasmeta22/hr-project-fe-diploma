...
const certificatesController = {
    createCertificate: async (certificateData: any) => {
        return await axios.post(`${apiUrl}/api/Certifikate`, certificateData).then((response) => response.data);
    },
    editCertificate: async (certificateId: any, certificateData: any) => {
        return await axios.put(`${apiUrl}/api/Certifikate/${certificateId}`, certificateData).then((response) => response.data);
    },
    deleteCertificate: async (certificateId: any) => {
        return await axios.delete(`${apiUrl}/api/Certifikate/${certificateId}`).then((response) => response.data);
    },
