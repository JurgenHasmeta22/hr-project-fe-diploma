...
test('displays the list of projects', async () => {
    ...
    projectsController.getAllProjects = jest
        .fn()
...
test('displays the list of permissions', async () => {
    ...
    permissionsController.getAllPermissions = jest
        .fn()
...
test('displays the correct project details', async () => {
    ...
    projectsController.getProject = jest
        .fn()
        .mockResolvedValue(mockProjectDetails);
    render(<Dashboard />);
    await waitFor(() => {
