...
test("renders change password form", () => {
    ...
    const confirmNewPasswordInput = screen.getByLabelText("Konfirmo passwordin");
...
test("displays error messages for invalid input", () => {
    ...
    const changePasswordButton = screen.getByText("Ndrysho passwordin");
    fireEvent.click(changePasswordButton);
    const oldPasswordError = screen.getByText("Passwordi aktual eshte i kerkuar");
    const newPasswordError = screen.getByText("Passwordi i ri eshte i kerkuar");
    const confirmNewPasswordError = screen.getByText("Duhet konfirmimi i passwordit");
...
test("displays success message after successful form submission", async () => {
    ...
    fireEvent.click(changePasswordButton);
    const successMessage = await screen.findByText("Ju keni ndryshuar passwordin me sukses");
...
test("displays error message after unsuccessful form submission", async () => {
    ...
    fireEvent.click(changePasswordButton);
    const errorMessage = await screen.findByText("Passwordi nuk eshte ndryshuar me sukses");
